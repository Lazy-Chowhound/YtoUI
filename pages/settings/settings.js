...
Page({
  data:{
    ...
    index: 0,                                  
    UI: [ 
      {title: "欢迎回来！", language: "选择语言", currentLan: "当前选择", employeeIdTitle: "雇员编号", currentId: "如有疑问请联系人事部门", employeeId: 'EMP10086RD', save: "保  存", accountMg: "账户管理", bind: "绑定COMPANY账户", unbind: "解除绑定", unbindMsgTitle: "解除账户绑定" , unbindMsgContent: "我已知晓解除与COMPANY账户的绑定后，将导致部分功能不可用。"},
      { title: "Welcome back!", language: "Change Language", currentLan: "Current", employeeIdTitle: "Employee ID", currentId: "Contact HR Dept.", employeeId: 'EMP10086RD', save: "Save Changes", accountMg: "Account Manage", bind: "Bind with COMPANY ID", unbind: "Unbind COMPANY ID", unbindMsgTitle: "Unbind Account" , unbindMsgContent: "I am aware unbinding COMPANY ID will cause some features to be unavailable."},
      { title: "お帰りなさい!", language: "言語変更", currentLan: "選択項目", employeeIdTitle: "社員番号", currentId: "人事部に連絡してください.", employeeId: 'EMP10086RD', save: "保  存", accountMg: "账户管理", bind: "绑定COMPANY账户", unbind: "解除绑定", unbindMsgTitle: "解除账户绑定" , unbindMsgContent: "我已知晓解除与COMPANY账户的绑定后，将导致部分功能不可用。"}
      ]
  },
